...
public class WordChains {
    ...
    public static void main(String[] args) {
        ...
        // Biggest ascii char from end word
        int greatestVal = 0;
        for (int i = 0; i < endWord.length(); i++) {
            int curVal = (int) endWord.charAt(i);
        ...
        // setup regex go through start word and replace . for every index
        // For example: cat, .at, c.t, .at
        String regex = null;
        System.out.println();
        ...
        System.out.println("searchForMatch");
        for (String str : contentList) {
            System.out.println(str);
        }

        System.out.println("oneCallableResult");
        for (String str : oneCallableResult) {
            System.out.println(str);
        }
    ...
    public static String getWord(Map<String, Integer> wordOccured, String endWord) {
        int max = 0; // Biggest occurrences
        String matchWord = null; // Word that we look for
        Map<String, Integer> wordHelper = new HashMap<>(); // map to store values with biggest occurences
        Map<Integer, String> wordHelperSeq = new HashMap<>(); // map to store values with biggest sequence
